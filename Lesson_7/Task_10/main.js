...
let users = [
    new User(2, 'Oleksandr', 'Oleksandr', 'oleksandr@email.com', '+10000000001'),
    new User(1, 'Serhii', 'Serhii', 'serhii@email.com', '+20000000002'),
...
Array.prototype.myFilter = function (predicat) {
    const array = [];
...
const filter = users.myFilter(user => user.id > 6);
console. log(filter);